...
function sortCitiesArray(arr) {
  return arr.sort((a, z) => {
    const compare = a.country.localeCompare(z.country);
    return compare === 0 ? a.city.localeCompare(z.city) : compare;
  });
}
